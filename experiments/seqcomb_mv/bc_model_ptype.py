...
def main(args):
    ...
    for i in range(1, 6):
        ...
        if is_timex:
            ...
            optimizer = torch.optim.AdamW(model.parameters(), lr = 2e-3, weight_decay = 0.001) #For regular
...
Saliency AUP: = 0.6804 +- 0.0052
Saliency AUR: = 0.3519 +- 0.0021


cnn:
============================================================================================
Saliency AUROC: = 0.9136 +- 0.0007
Saliency AUPRC: = 0.7822 +- 0.0012
Saliency AUP: = 0.8896 +- 0.0005
Saliency AUR: = 0.3434 +- 0.0012
"""
