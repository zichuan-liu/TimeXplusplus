...
def main(args):
    ...
    tencoder_path = "/TimeX/experiments/Boiler/models/transformer_split={}.pt"
    ...
    for i in range(4, 6):#2, 6
        trainB, val, test = process_Boiler_OLD(split_no = i, device = device, base_path = '/TimeX/datasets/Boiler/')
